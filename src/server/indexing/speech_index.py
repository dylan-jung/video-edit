...
from src.server.indexing.embedding.speech_to_string import speech_to_string


def index_speech(project_id: str, video_id: str, speech_analysis_path: str, vector_db_url: str):
    ...
    if not vector_db.is_video_indexed(video_id):
        ...
        for i, chunk in enumerate(speech_chunks):
            ...
            embedding = embedding_generator.generate_text_embedding(search_text)
